...
int		main(void)
{
	...
	const TESTED_NAMESPACE::vector<TESTED_TYPE> cvct(size);
	TESTED_NAMESPACE::vector<TESTED_TYPE>::const_reverse_iterator cit_0 = cvct.rbegin();
	...
	cit_1 = cvct.rend();
	it_mid = it_0 + 3;
	cit_mid = cit_0 + 3; cit_mid = cit_0 + 3;// cit_mid = it_mid;
